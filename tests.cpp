...
int main(int argc, char* argv[]) {
    ...
    Graphs::Weight q = static_cast<Graphs::Weight>(std::stoll(argv[3]));
    Graphs::Weight r = static_cast<Graphs::Weight>(std::stoll(argv[4]));
    ...
    if (mode == 'A') {
        ...
        Graphs::dijkstraWithMarks(g.getCountOfVertices(), matrix, 1);
        ...
        Timer::getTimeSinceLastCall();
        Graphs::fordBellman(g.getCountOfVertices(), edge_list, 1);
        t = Timer::getTimeSinceLastCall();
    }
